...
const char* ssid     = "Kanokwan"; //NAYNE //Kanokwan  //DESKTOP-9GRKCEU 
const char* password = "Frogs2512"; //nayne38657 //Frogs2512 //b348@77S
...
if ((WiFiMulti.run() == WL_CONNECTED)) {
    WiFiClient client;
    HTTPClient http;
    if (http.begin(client, "http://192.168.1.100/project/readfeed.php")) {  // HTTP
  ...
  // auto
    ...
    WiFiClient client;
    HTTPClient http;
    if (http.begin(client, "http://192.168.1.100/project/readauto.php")) {  // HTTP
      int httpCode = http.GET();
      if (httpCode > 0) {
        if (httpCode == HTTP_CODE_OK || httpCode == HTTP_CODE_MOVED_PERMANENTLY) {
          String payload = http.getString();
...
if ((WiFiMulti.run() == WL_CONNECTED)) {
    WiFiClient client;
    HTTPClient http;
    if (http.begin(client, "http://192.168.1.100/project/readlight.php")) {  // HTTP
      int httpCode = http.GET();
      if (httpCode > 0) {
        if (httpCode == HTTP_CODE_OK || httpCode == HTTP_CODE_MOVED_PERMANENTLY) {
          String payload = http.getString();
...
if ((WiFiMulti.run() == WL_CONNECTED)) {
    WiFiClient client;
    HTTPClient http;
    if (http.begin(client, "http://192.168.1.100/project/readquality.php")) {  // HTTP
      int httpCode = http.GET();
      if (httpCode > 0) {
        if (httpCode == HTTP_CODE_OK || httpCode == HTTP_CODE_MOVED_PERMANENTLY) {
          String payload = http.getString();
...
//load datax  
   if ((WiFiMulti.run() == WL_CONNECTED)) {
    WiFiClient client;
    HTTPClient http;
    if (http.begin(client, "http://192.168.1.100/project/readdatax.php")) {  // HTTP
      int httpCode = http.GET();
      if (httpCode > 0) {
        if (httpCode == HTTP_CODE_OK || httpCode == HTTP_CODE_MOVED_PERMANENTLY) {
...
void status_display(){
 ...
 void true_light(){
    ...
    WiFiClient client;
    HTTPClient http;
    if (http.begin(client, "http://192.168.1.100/project/rgb_r.php")) {  // HTTP
      int httpCode = http.GET();
      if (httpCode > 0) {
        if (httpCode == HTTP_CODE_OK || httpCode == HTTP_CODE_MOVED_PERMANENTLY) {
          String payload = http.getString();
    ...
    WiFiClient client;
    HTTPClient http;
    if (http.begin(client, "http://192.168.1.100/project/rgb_g.php")) {  // HTTP
      int httpCode = http.GET();
      if (httpCode > 0) {
        if (httpCode == HTTP_CODE_OK || httpCode == HTTP_CODE_MOVED_PERMANENTLY) {
          String payload = http.getString();
    ...
    WiFiClient client;
    HTTPClient http;
    if (http.begin(client, "http://192.168.1.100/project/rgb_b.php")) {  // HTTP
      int httpCode = http.GET();
      if (httpCode > 0) {
        if (httpCode == HTTP_CODE_OK || httpCode == HTTP_CODE_MOVED_PERMANENTLY) {
          String payload = http.getString();
